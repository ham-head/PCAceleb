...
def draw_sliders():
	for i in range(num_params):
		...
		pygame.draw.circle(screen, slider_color, (cx, int(round(py))), round(slider_w/2 - slider_px))
...
def draw_face():
	pygame.surfarray.blit_array(face_surface_mini, cur_face)
